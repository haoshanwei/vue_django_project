<template>
    <div class="reportShow">
        ...
        <div v-for="(test_suite_summary, suite_index) in details" :key="suite_index">
            <h3>{{test_suite_summary.name}}</h3>
            <table :id="'suite' + suite_index" class="details">
                <tr>
                    <th>base_url</th>
                                ...
                                <div class="content">
                                    <div style="overflow: auto">
                                        <table>
                                            ...
                                            <tr v-for="(in_out, key) in test_suite_summary.output" :key='key'>
                                                <td>{{in_out.in}}</td>
                                                <td>{{in_out.out}}</td>
                                            </tr>
                ...
                <tr v-for="(record, key) in test_suite_summary.records" :id="'record_' + suite_index + '_' + key" :key="key">
                                ...
                                <div class="content">
                                    ...
                                    <div style="overflow: auto">
                                        <table>
                                            ...
                                            <div v-for="(value, key) in record.meta_data.request" :key="key">      
                                                <tr>
                                                    <th>{{key}}</th>
                                                    <td>
                                                        <template v-if="key === 'headers'">
                                                            <div v-for="(header_value, header_key) in record.meta_data.request.headers" :key="header_key">
                                    ...
                                    <div style="overflow: auto">
                                        <table>
                                            <div v-for="(value, key) in record.meta_data.response" :key="key">
                                                <tr>
                                                    <th>{{key}}</th>
                                                    <td>
                                                        <template v-if="key === 'headers'">
                                    ...
                                    <div style="overflow: auto">
                                        <table>
                                            ...
                                            <tr v-for="(validator, index) in record.meta_data.validators" :key="index">
